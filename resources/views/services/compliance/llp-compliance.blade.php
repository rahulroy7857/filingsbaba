...
@section('title', 'LLP Compliance - FilingsBaba')
            ...
            <div class="row">
                <div class="col-lg-8 col-md-12 col-sm-12">
                    <div class="service-details-content">
                        <div class="image-box">
                            <img src="{{ asset('main/images/services/llp-compliance.jpg') }}" alt="LLP Compliance">
                        </div>

                        <div class="content-box">
                            <h2>LLP Compliance</h2>
                            <p>Ensure your Limited Liability Partnership meets all statutory compliance requirements with
                                our comprehensive LLP compliance services. We help LLPs maintain regulatory standards and
                                avoid penalties through timely filings.</p>

                            <div class="features-box">
                                <h3>What We Offer</h3>
                                <ul>
                                    <li><i class="lnr lnr-checkmark-circle"></i> LLP Form 11 Filing</li>
                                    <li><i class="lnr lnr-checkmark-circle"></i> LLP Form 8 Filing</li>
                                    <li><i class="lnr lnr-checkmark-circle"></i> Annual Compliance Filing</li>
                                    <li><i class="lnr lnr-checkmark-circle"></i> Partner Changes</li>
                                    <li><i class="lnr lnr-checkmark-circle"></i> Business Address Changes</li>
                            ...
                            <div class="requirements-box">
                                ...
                                <ul>
                                    <li>LLP Registration Certificate</li>
                            ...
                            <div class="faq-section">
                                ...
                                <div class="faq-item">
                                    <div class="faq-question">What is LLP Compliance?</div>
                                ...
                                <div class="faq-item">
                                    <div class="faq-question">What are the mandatory LLP compliance requirements?</div>
                                    <div class="faq-answer">
                                ...
                                <div class="faq-item">
                                    <div class="faq-question">What is the penalty for non-compliance?</div>
                                    <div class="faq-answer">
                                ...
                                <div class="faq-item">
                                    <div class="faq-question">When should Form 11 be filed?</div>
                                    <div class="faq-answer">
                                ...
                                <div class="faq-item">
                                    <div class="faq-question">What is Form 8 in LLP compliance?</div>
                                    <div class="faq-answer">
