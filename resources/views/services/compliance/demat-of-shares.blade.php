...
@section('title', 'Demat of Shares - FilingsBaba')
            ...
            <div class="row">
                <div class="col-lg-8 col-md-12 col-sm-12">
                    <div class="service-details-content">
                        <div class="image-box">
                            <img src="{{ asset('main/images/services/demat-of-shares.jpg') }}" alt="Demat of Shares">
                        </div>

                        <div class="content-box">
                            <h2>Demat of Shares</h2>
                            <p>Convert your physical share certificates to electronic format through our dematerialization
                                services. We ensure smooth processing and compliance with SEBI regulations for all demat
                                conversions.</p>

                            <div class="features-box">
                                <h3>What We Offer</h3>
                                <ul>
                                    <li><i class="lnr lnr-checkmark-circle"></i> Physical to Demat Conversion</li>
                                    <li><i class="lnr lnr-checkmark-circle"></i> Document Preparation</li>
                                    <li><i class="lnr lnr-checkmark-circle"></i> DP Account Opening</li>
                                    <li><i class="lnr lnr-checkmark-circle"></i> SEBI Compliance</li>
                                    <li><i class="lnr lnr-checkmark-circle"></i> Status Monitoring</li>
                                    <li><i class="lnr lnr-checkmark-circle"></i> Post-conversion Support</li>
                                </ul>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="process-step">
                                            ...
                                            <h4>DP Account</h4>
                                            <p>Open Demat account with DP.</p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="process-step">
                                            ...
                                            <h4>Documentation</h4>
                                            <p>Prepare demat request form.</p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="process-step">
                            ...
                            <div class="requirements-box">
                                ...
                                <ul>
                                    <li>Physical Share Certificates</li>
                                    <li>Demat Request Form</li>
                                    <li>DP Account Details</li>
                                    <li>PAN Card</li>
                                    <li>Aadhaar Card</li>
                            ...
                            <div class="benefits-box">
                                <h3>Benefits</h3>
                                <ul>
                                    <li><i class="lnr lnr-arrow-right"></i> Safe Storage</li>
                                    <li><i class="lnr lnr-arrow-right"></i> Easy Transfer</li>
                                    <li><i class="lnr lnr-arrow-right"></i> No Physical Risk</li>
                                    <li><i class="lnr lnr-arrow-right"></i> Quick Processing</li>
                                    <li><i class="lnr lnr-arrow-right"></i> SEBI Compliance</li>
                                </ul>
                            </div>
                            ...
                            <div class="faq-section">
                                ...
                                <div class="faq-item">
                                    <div class="faq-question">What is Demat of Shares?</div>
                                    <div class="faq-answer">
                                        Demat of shares is the process of converting physical share certificates into
                                        electronic format, making them easier to trade and manage.
                                    </div>
                                </div>

                                <div class="faq-item">
                                    <div class="faq-question">How long does the demat process take?</div>
                                    <div class="faq-answer">
                                        The demat process typically takes 15-30 days, depending on the company and R&T agent
                                        processing time.
                                    </div>
                                </div>

                                <div class="faq-item">
                                    <div class="faq-question">Is demat mandatory?</div>
                                    <div class="faq-answer">
                                        Yes, SEBI has made demat mandatory for trading in most securities. Physical shares
                                        cannot be traded on exchanges.
                                    </div>
                                </div>

                                <div class="faq-item">
                                    <div class="faq-question">What is a DP Account?</div>
                                    <div class="faq-answer">
                                        A DP (Depository Participant) account is like a bank account for shares, where
                                        electronic shares are held and managed.
                                    </div>
                                </div>

                                <div class="faq-item">
                                    <div class="faq-question">Can I convert all types of shares?</div>
                                    <div class="faq-answer">
                                        Most listed company shares can be converted to demat. Some unlisted or restricted
                                        shares may have limitations.
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="sidebar">
                        ...
                        <div class="pricing-widget">
                            ...
                            <div class="price-info">
                                ...
                                <div class="duration">Per Certificate</div>
                            </div>
