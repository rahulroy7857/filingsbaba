...
@section('title', 'Name Change - Company - FilingsBaba')
            ...
            <div class="row">
                <div class="col-lg-8 col-md-12 col-sm-12">
                    <div class="service-details-content">
                        <div class="image-box">
                            <img src="{{ asset('main/images/services/name-change-company.jpg') }}"
                                alt="Name Change - Company">
                        </div>

                        <div class="content-box">
                            <h2>Name Change - Company</h2>
                            <p>Change your company name legally and efficiently with our comprehensive name change services.
                                We handle all the necessary filings and ensure compliance with regulatory requirements.</p>

                            <div class="features-box">
                                <h3>What We Offer</h3>
                                <ul>
                                    <li><i class="lnr lnr-checkmark-circle"></i> Name Availability Check</li>
                                    ...
                                    <li><i class="lnr lnr-checkmark-circle"></i> Document Updates</li>
                                </ul>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="process-step">
                                            ...
                                            <h4>Name Availability</h4>
                                            <p>Professional handling of name availability check with expert guidance.</p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="process-step">
                            ...
                            <div class="benefits-box">
                                <h3>Benefits</h3>
                                <ul>
                                    <li><i class="lnr lnr-arrow-right"></i> Legal Name Change</li>
                                    <li><i class="lnr lnr-arrow-right"></i> Brand Alignment</li>
                            ...
                            <div class="faq-section">
                                ...
                                <div class="faq-item">
                                    <div class="faq-question">What is Company Name Change?</div>
                                    <div class="faq-answer">
                                        Company name change is the legal process of changing the registered name of a
                                        company with the Registrar of Companies (ROC) and updating all related documents and
                                        registrations.
                                    </div>
                                </div>

                                <div class="faq-item">
                                    <div class="faq-question">How long does the name change process take?</div>
                                    <div class="faq-answer">
                                        The complete name change process typically takes 30-45 days, including ROC approval,
                                        document updates, and notification to various authorities.
                                    </div>
                                </div>

                                <div class="faq-item">
                                    <div class="faq-question">What documents need to be updated after name change?</div>
                                    <div class="faq-answer">
                                        Documents to be updated include PAN, GST registration, bank accounts, licenses,
                                        contracts, letterheads, and all business-related documents.
                                    </div>
                                </div>

                                <div class="faq-item">
                                    <div class="faq-question">Can any name be chosen for the company?</div>
                                    <div class="faq-answer">
                                        No, the name must comply with Companies Act guidelines, should not be identical to
                                        existing companies, and should not be offensive or misleading.
                                    </div>
                                </div>

                                <div class="faq-item">
                                    <div class="faq-question">Is shareholder approval required for name change?</div>
                                    <div class="faq-answer">
                                        Yes, a special resolution must be passed by shareholders with at least 75% majority
