...
@section('title', 'Winding Up - LLP - FilingsBaba')
            ...
            <div class="row">
                <div class="col-lg-8 col-md-12 col-sm-12">
                    <div class="service-details-content">
                        <div class="image-box">
                            <img src="{{ asset('main/images/services/winding-up-llp.jpg') }}" alt="Winding Up - LLP">
                        </div>

                        <div class="content-box">
                            <h2>Winding Up - LLP</h2>
                            <p>Close your Limited Liability Partnership (LLP) legally and efficiently through our
                                comprehensive winding up services. We handle the complete process from documentation to
                                final closure with regulatory compliance.</p>
                            ...
                            <div class="faq-section">
                                ...
                                <div class="faq-item">
                                    <div class="faq-question">What is LLP Winding Up?</div>
                                ...
                                <div class="faq-item">
                                    <div class="faq-question">Can an LLP be revived after winding up?</div>
                                    <div class="faq-answer">
                                ...
                                <div class="faq-item">
                                    <div class="faq-question">What happens to the partners' liability?</div>
                                    <div class="faq-answer">
