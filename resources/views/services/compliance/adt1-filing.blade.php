...
@section('title', 'ADT-1 Filing - FilingsBaba')
            ...
            <div class="row">
                <div class="col-lg-8 col-md-12 col-sm-12">
                    <div class="service-details-content">
                        <div class="image-box">
                            <img src="{{ asset('main/images/services/adt1-filing.jpg') }}" alt="ADT-1 Filing">
                        </div>

                        <div class="content-box">
                            <h2>ADT-1 Filing</h2>
                            <p>File your ADT-1 (Appointment of Auditor) form efficiently with our professional services. We
                            ...
                            <div class="features-box">
                                <h3>What We Offer</h3>
                                <ul>
                                    <li><i class="lnr lnr-checkmark-circle"></i> Auditor Appointment</li>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="process-step">
                                            ...
                                            <h4>Auditor Selection</h4>
                                            <p>Professional handling of auditor selection with expert guidance.</p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="process-step">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="process-step">
                                            ...
                                            <h4>ADT-1 Filing</h4>
                                            <p>Professional handling of ADT-1 filing with expert guidance.</p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="process-step">
                            ...
                            <div class="faq-section">
                                ...
                                <div class="faq-item">
                                    <div class="faq-question">What is ADT-1 Filing?</div>
                                ...
                                <div class="faq-item">
                                    <div class="faq-question">When should ADT-1 be filed?</div>
                                    <div class="faq-answer">
                                ...
                                <div class="faq-item">
                                    <div class="faq-question">What is the penalty for late filing?</div>
                                    <div class="faq-answer">
                                ...
                                <div class="faq-item">
                                    <div class="faq-question">Who can be appointed as an auditor?</div>
                                    <div class="faq-answer">
                                ...
                                <div class="faq-item">
                                    <div class="faq-question">Is shareholder approval required for auditor appointment?
                                    </div>
                                    <div class="faq-answer">
