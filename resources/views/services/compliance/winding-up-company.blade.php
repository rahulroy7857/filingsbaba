...
@section('title', 'Winding Up - Company - FilingsBaba')
            ...
            <div class="row">
                <div class="col-lg-8 col-md-12 col-sm-12">
                    <div class="service-details-content">
                        <div class="image-box">
                            <img src="{{ asset('main/images/services/winding-up-company.jpg') }}"
                                alt="Winding Up - Company">
                        </div>

                        <div class="content-box">
                            <h2>Winding Up - Company</h2>
                            <p>Close your company legally and efficiently through our comprehensive winding up services.
                                We handle the complete process from documentation to final closure with regulatory
                                compliance.</p>

                            <div class="features-box">
                                <h3>What We Offer</h3>
                                <ul>
                                    <li><i class="lnr lnr-checkmark-circle"></i> Voluntary Winding Up</li>
                                    <li><i class="lnr lnr-checkmark-circle"></i> Document Preparation</li>
                                    <li><i class="lnr lnr-checkmark-circle"></i> Creditor Settlement</li>
                                    <li><i class="lnr lnr-checkmark-circle"></i> Asset Distribution</li>
                                    <li><i class="lnr lnr-checkmark-circle"></i> ROC Filing</li>
                                    <li><i class="lnr lnr-checkmark-circle"></i> Final Closure</li>
                                </ul>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="process-step">
                                            ...
                                            <h4>Resolution</h4>
                                            <p>Pass winding up resolution.</p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="process-step">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="process-step">
                                            ...
                                            <h4>Creditor Settlement</h4>
                                            <p>Settle all creditors.</p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="process-step">
                                            ...
                                            <h4>Final Closure</h4>
                                            <p>Complete winding up process.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="benefits-box">
                                <h3>Benefits</h3>
                                <ul>
                                    <li><i class="lnr lnr-arrow-right"></i> Legal Closure</li>
                                    <li><i class="lnr lnr-arrow-right"></i> Debt Settlement</li>
                                    <li><i class="lnr lnr-arrow-right"></i> Asset Distribution</li>
                            ...
                            <div class="faq-section">
                                ...
                                <div class="faq-item">
                                    <div class="faq-question">What is Company Winding Up?</div>
                                    <div class="faq-answer">
                                        Company winding up is the legal process of closing a company. It involves settling
                                        all debts, distributing assets, and formally dissolving the company.
                                    </div>
                                </div>

                                <div class="faq-item">
                                    <div class="faq-question">How long does the winding up process take?</div>
                                    <div class="faq-answer">
                                        The winding up process typically takes 6-18 months, depending on the complexity of
                                        assets, number of creditors, and regulatory requirements.
                                    </div>
                                </div>

                                <div class="faq-item">
                                    <div class="faq-question">What are the types of winding up?</div>
                                    <div class="faq-answer">
                                        There are two types: voluntary winding up (by shareholders' decision) and compulsory
                                        winding up (by court order).
                                    </div>
                                </div>

                                <div class="faq-item">
                                    <div class="faq-question">Can a company be revived after winding up?</div>
                                    <div class="faq-answer">
                                        In certain cases, a company can be revived within 2 years of winding up by filing an
                                        application with the NCLT.
                                    </div>
                                </div>

                                <div class="faq-item">
                                    <div class="faq-question">What happens to the directors' liability?</div>
                                    <div class="faq-answer">
                                        Directors' liability depends on the type of company. In private companies, liability
                    ...
                    <div class="sidebar">
                        ...
                        <div class="pricing-widget">
                            ...
                            <div class="price-info">
                                ...
                                <div class="duration">Complete Process</div>
                            </div>
