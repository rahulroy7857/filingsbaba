...
@section('title', 'Director Change - FilingsBaba')
@section('styles')
    <style>
            ...
            <div class="row">
                <div class="col-lg-8 col-md-12 col-sm-12">
                    <div class="service-details-content">
                        <div class="image-box">
                            <img src="{{ asset('main/images/services/director-change.jpg') }}" alt="Director Change">
                        </div>

                        <div class="content-box">
                            <h2>Director Change</h2>
                            <p>Add or change directors in your company efficiently with our professional director change
                                services. We handle all the necessary procedures and filings to ensure smooth director
                                transitions.</p>

                            <div class="features-box">
                                <h3>What We Offer</h3>
                                <ul>
                                    <li><i class="lnr lnr-checkmark-circle"></i> Director Addition</li>
                                    <li><i class="lnr lnr-checkmark-circle"></i> Director Resignation</li>
                                    <li><i class="lnr lnr-checkmark-circle"></i> Board Resolution</li>
                                    <li><i class="lnr lnr-checkmark-circle"></i> ROC Filing</li>
                                    <li><i class="lnr lnr-checkmark-circle"></i> DIN Processing</li>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="process-step">
                                            ...
                                            <p>Professional handling of board resolution with expert guidance.</p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="process-step">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="process-step">
                                            ...
                                            <h4>Confirmation</h4>
                                            <p>Professional handling of confirmation with expert guidance.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="benefits-box">
                                <h3>Benefits</h3>
                                <ul>
                                    <li><i class="lnr lnr-arrow-right"></i> Legal Director Change</li>
                            ...
                            <div class="faq-section">
                                ...
                                <div class="faq-item">
                                    <div class="faq-question">What is Director Change?</div>
                                    <div class="faq-answer">
                                        Director change is the legal process of appointing, resigning, or removing directors
                                        from a company and updating the same with the Registrar of Companies (ROC).
                                    </div>
                                </div>

                                <div class="faq-item">
                                    <div class="faq-question">How long does the director change process take?</div>
                                    <div class="faq-answer">
                                        The director change process typically takes 15-30 days, including board approval,
                                        shareholder approval (if required), and ROC filing.
                                    </div>
                                </div>

                                <div class="faq-item">
                                    <div class="faq-question">What forms are required for director change?</div>
                                    <div class="faq-answer">
                                        Required forms include DIR-2 (for appointment), DIR-11 (for resignation), DIR-12
                                        (for change in particulars), and related board resolutions.
                                    </div>
                                </div>

                                <div class="faq-item">
                                    <div class="faq-question">Is shareholder approval required for director appointment?
                                    </div>
                                    <div class="faq-answer">
                                        For public companies, shareholder approval is required for director appointment. For
                                        private companies, board approval is usually sufficient.
                                    </div>
                                </div>

                                <div class="faq-item">
                                    <div class="faq-question">Can a disqualified person be appointed as director?</div>
                                    <div class="faq-answer">
                                        No, a person who is disqualified under Section 164 of the Companies Act, 2013,
                                        cannot be appointed as a director of any company.
                                    </div>
                                </div>
                            </div>
                        </div>
