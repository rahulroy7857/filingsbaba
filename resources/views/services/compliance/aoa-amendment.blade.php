...
@section('title', 'AOA Amendment - FilingsBaba')
            ...
            <div class="row">
                <div class="col-lg-8 col-md-12 col-sm-12">
                    <div class="service-details-content">
                        <div class="image-box">
                            <img src="{{ asset('main/images/services/aoa-amendment.jpg') }}" alt="AOA Amendment">
                        </div>

                        <div class="content-box">
                            <h2>AOA Amendment</h2>
                            <p>Amend your company's Articles of Association (AOA) to modify internal rules, regulations,
                                and procedures. Our expert team ensures smooth processing and regulatory compliance for
                                all AOA amendments.</p>

                            <div class="features-box">
                                <h3>What We Offer</h3>
                                <ul>
                                    <li><i class="lnr lnr-checkmark-circle"></i> AOA Amendment Filing</li>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="process-step">
                                            ...
                                            <p>Assess the required changes in AOA.</p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="process-step">
                                            ...
                                            <p>Prepare amended AOA and supporting documents.</p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="process-step">
