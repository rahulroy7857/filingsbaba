...
@section('title', 'Dormant Status Filing - FilingsBaba')
            ...
            <div class="row">
                <div class="col-lg-8 col-md-12 col-sm-12">
                    <div class="service-details-content">
                        <div class="image-box">
                            <img src="{{ asset('main/images/services/dormant-status-filing.jpg') }}"
                                alt="Dormant Status Filing">
                        </div>

                        <div class="content-box">
                            <h2>Dormant Status Filing</h2>
                            <p>Convert your inactive company to dormant status to avoid compliance requirements and reduce
                                operational costs. Our expert team helps you file for dormant status with proper
                                documentation and regulatory compliance.</p>

                            <div class="features-box">
                                <h3>What We Offer</h3>
                                <ul>
                                    <li><i class="lnr lnr-checkmark-circle"></i> Dormant Status Application</li>
                                    <li><i class="lnr lnr-checkmark-circle"></i> Document Preparation</li>
                                    <li><i class="lnr lnr-checkmark-circle"></i> ROC Filing Support</li>
                                    <li><i class="lnr lnr-checkmark-circle"></i> Compliance Verification</li>
                                    <li><i class="lnr lnr-checkmark-circle"></i> Status Monitoring</li>
                                    <li><i class="lnr lnr-checkmark-circle"></i> Post-filing Support</li>
                                </ul>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="process-step">
                                            ...
                                            <p>Verify company eligibility for dormant status filing.</p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="process-step">
                                            ...
                                            <p>Prepare all required documents and forms.</p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="process-step">
                                            ...
                                            <p>File application with ROC for dormant status.</p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="process-step">
                                            ...
                                            <p>Receive confirmation and monitor status.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="requirements-box">
                                ...
                                <ul>
                                    <li>Board Resolution for Dormant Status</li>
                                    <li>Company Registration Certificate</li>
                                    <li>Financial Statements</li>
                                    <li>Directors' Consent</li>
                                    <li>No Business Activity Certificate</li>
                            ...
                            <div class="benefits-box">
                                <h3>Benefits</h3>
                                <ul>
                                    <li><i class="lnr lnr-arrow-right"></i> Reduced Compliance Burden</li>
                                    <li><i class="lnr lnr-arrow-right"></i> Lower Operational Costs</li>
                                    <li><i class="lnr lnr-arrow-right"></i> Maintain Company Structure</li>
                                    <li><i class="lnr lnr-arrow-right"></i> Easy Reactivation Process</li>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="pricing-block">
                        <div class="inner-box">
                            ...
                            <div class="content">
                                <ul>
                                    <li>Basic Dormant Status Filing</li>
