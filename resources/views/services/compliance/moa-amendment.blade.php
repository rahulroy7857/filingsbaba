...
@section('title', 'MOA Amendment - FilingsBaba')
            ...
            <div class="row">
                <div class="col-lg-8 col-md-12 col-sm-12">
                    <div class="service-details-content">
                        <div class="image-box">
                            <img src="{{ asset('main/images/services/moa-amendment.jpg') }}" alt="MOA Amendment">
                        </div>

                        <div class="content-box">
                            <h2>MOA Amendment</h2>
                            <p>Amend your company's Memorandum of Association (MOA) to reflect changes in business
                                objectives, registered office, or other fundamental aspects. Our expert team ensures
                                smooth processing and regulatory compliance.</p>

                            <div class="features-box">
                                <h3>What We Offer</h3>
                                <ul>
                                    <li><i class="lnr lnr-checkmark-circle"></i> MOA Amendment Filing</li>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="process-step">
                                            ...
                                            <p>Assess the required changes in MOA.</p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="process-step">
                                            ...
                                            <p>Prepare amended MOA and supporting documents.</p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="process-step">
                                            ...
                                            <p>Obtain board approval for amendments.</p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="process-step">
                            ...
                            <div class="requirements-box">
                                ...
                                <ul>
                                    <li>Board Resolution for Amendment</li>
                                    <li>Amended MOA</li>
                            ...
                            <div class="benefits-box">
                                ...
                                <ul>
                                    ...
                                    <li><i class="lnr lnr-arrow-right"></i> Regulatory Updates</li>
