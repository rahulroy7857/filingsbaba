...
@section('title', 'Share Transfer - FilingsBaba')
            ...
            <div class="row">
                <div class="col-lg-8 col-md-12 col-sm-12">
                    <div class="service-details-content">
                        <div class="image-box">
                            <img src="{{ asset('main/images/services/share-transfer.jpg') }}" alt="Share Transfer">
                        </div>

                        <div class="content-box">
                            <h2>Share Transfer</h2>
                            <p>Transfer shares between shareholders with proper documentation and regulatory compliance.
                                Our expert team ensures smooth processing and legal compliance for all share transfer
                                transactions.</p>

                            <div class="features-box">
                                <h3>What We Offer</h3>
                                <ul>
                                    <li><i class="lnr lnr-checkmark-circle"></i> Share Transfer Filing</li>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="process-step">
                                            ...
                                            <h4>Transfer Agreement</h4>
                                            <p>Prepare share transfer agreement.</p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="process-step">
                    ...
                    <div class="sidebar">
                        ...
                        <div class="pricing-widget">
                            ...
                            <div class="price-info">
                                ...
                                <div class="duration">Per Transfer</div>
                            </div>
