...
@section('title', 'Authorized Capital Increase - FilingsBaba')
            ...
            <div class="row">
                <div class="col-lg-8 col-md-12 col-sm-12">
                    <div class="service-details-content">
                        <div class="image-box">
                            <img src="{{ asset('main/images/services/authorized-capital-increase.jpg') }}"
                                alt="Authorized Capital Increase">
                        </div>

                        <div class="content-box">
                            <h2>Authorized Capital Increase</h2>
                            <p>Increase your company's authorized capital to accommodate business growth and expansion.
                                Our expert team handles the complete process from documentation to ROC filing.</p>

                            <div class="features-box">
                                <h3>What We Offer</h3>
                                <ul>
                                    <li><i class="lnr lnr-checkmark-circle"></i> Capital Increase Filing</li>
                                    <li><i class="lnr lnr-checkmark-circle"></i> Document Preparation</li>
                                    <li><i class="lnr lnr-checkmark-circle"></i> ROC Filing Support</li>
                                    <li><i class="lnr lnr-checkmark-circle"></i> Legal Compliance</li>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="process-step">
                                            ...
                                            <h4>Capital Assessment</h4>
                                            <p>Assess the required capital increase.</p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="process-step">
                                            ...
                                            <p>Prepare necessary documents.</p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="process-step">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="process-step">
                                            ...
                                            <h4>ROC Filing</h4>
                                            <p>File with ROC for approval.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="benefits-box">
                                <h3>Benefits</h3>
                                <ul>
                                    <li><i class="lnr lnr-arrow-right"></i> Business Growth</li>
                                    <li><i class="lnr lnr-arrow-right"></i> Legal Compliance</li>
                                    <li><i class="lnr lnr-arrow-right"></i> Investment Opportunities</li>
