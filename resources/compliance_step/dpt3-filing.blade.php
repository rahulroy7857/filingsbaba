...
@section('title', 'DPT-3 Filing - FilingsBaba')
            ...
            <div class="row">
                <div class="col-lg-8 col-md-12 col-sm-12">
                    <div class="service-details-content">
                        <div class="image-box">
                            <img src="{{ asset('main/images/services/dpt3-filing.jpg') }}" alt="DPT-3 Filing">
                        </div>

                        <div class="content-box">
                            <h2>DPT-3 Filing</h2>
                            <p>File your DPT-3 (Return of Deposits) form efficiently with our professional services. We
                                ensure timely compliance and help you maintain proper records for your company.</p>

                            <div class="features-box">
                                <h3>What We Offer</h3>
                                <ul>
                                    <li><i class="lnr lnr-checkmark-circle"></i> Deposit Details Collection</li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="process-step">
                                            ...
                                            <h4>DPT-3 Filing</h4>
                                            <p>Professional handling of DPT-3 filing with expert guidance.</p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="process-step">
                            ...
                            <div class="faq-section">
                                ...
                                <div class="faq-item">
                                    <div class="faq-question">What is DPT-3 Filing?</div>
                                ...
                                <div class="faq-item">
                                    <div class="faq-question">When should DPT-3 be filed?</div>
                                    <div class="faq-answer">
                                ...
                                <div class="faq-item">
                                    <div class="faq-question">Which companies need to file DPT-3?</div>
                                    <div class="faq-answer">
                                ...
                                <div class="faq-item">
                                    <div class="faq-question">What information is required in DPT-3?</div>
                                    <div class="faq-answer">
