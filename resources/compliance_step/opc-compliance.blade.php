...
@section('title', 'OPC Compliance - FilingsBaba')
            ...
            <div class="row">
                <div class="col-lg-8 col-md-12 col-sm-12">
                    <div class="service-details-content">
                        <div class="image-box">
                            <img src="{{ asset('main/images/services/opc-compliance.jpg') }}" alt="OPC Compliance">
                        </div>

                        <div class="content-box">
                            <h2>OPC Compliance</h2>
                            <p>Ensure your One Person Company meets all statutory compliance requirements with our
                                comprehensive OPC compliance services. We help OPCs maintain regulatory standards and avoid
                                penalties through timely filings.</p>
                            ...
                            <div class="requirements-box">
                                ...
                                <ul>
                                    <li>OPC Registration Certificate</li>
                                    <li>Board Resolution</li>
                                    <li>Financial Statements</li>
                                    <li>Audit Reports</li>
                                    <li>Director's Details</li>
                            ...
                            <div class="faq-section">
                                ...
                                <div class="faq-item">
                                    <div class="faq-question">What is OPC Compliance?</div>
                                ...
                                <div class="faq-item">
                                    <div class="faq-question">What are the mandatory OPC compliance requirements?</div>
                                    <div class="faq-answer">
                                ...
                                <div class="faq-item">
                                    <div class="faq-question">Are board meetings required for OPC?</div>
                                    <div class="faq-answer">
                                ...
                                <div class="faq-item">
                                    <div class="faq-question">Can an OPC be converted to a private company?</div>
                                    <div class="faq-answer">
