...
@section('title', 'DIN Reactivation - FilingsBaba')
            ...
            <div class="row">
                <div class="col-lg-8 col-md-12 col-sm-12">
                    <div class="service-details-content">
                        <div class="image-box">
                            <img src="{{ asset('main/images/services/din-reactivation.jpg') }}" alt="DIN Reactivation">
                        </div>

                        <div class="content-box">
                            <h2>DIN Reactivation</h2>
                            <p>Reactivate your deactivated Director Identification Number (DIN) efficiently with our
                            ...
                            <div class="features-box">
                                <h3>What We Offer</h3>
                                <ul>
                                    <li><i class="lnr lnr-checkmark-circle"></i> DIN Status Check</li>
                                    <li><i class="lnr lnr-checkmark-circle"></i> Reactivation Application</li>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="process-step">
                                            ...
                                            <p>Professional handling of status verification with expert guidance.</p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="process-step">
                                            ...
                                            <p>Professional handling of application preparation with expert guidance.</p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="process-step">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="process-step">
                                            ...
                                            <h4>Reactivation Confirmation</h4>
                                            <p>Professional handling of reactivation confirmation with expert guidance.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="requirements-box">
                                ...
                                <ul>
                                    <li>Deactivated DIN Number</li>
                                    <li>Identity Proof</li>
                                    <li>Address Proof</li>
                                    <li>Reactivation Justification</li>
                            ...
                            <div class="benefits-box">
                                <h3>Benefits</h3>
                                <ul>
                                    <li><i class="lnr lnr-arrow-right"></i> DIN Reactivation</li>
                                    <li><i class="lnr lnr-arrow-right"></i> Compliance Restoration</li>
                            ...
                            <div class="faq-section">
                                ...
                                <div class="faq-item">
                                    <div class="faq-question">What is DIN Reactivation?</div>
                                ...
                                <div class="faq-item">
                                    <div class="faq-question">When does a DIN get deactivated?</div>
                                    <div class="faq-answer">
                                ...
                                <div class="faq-item">
                                    <div class="faq-question">How long does DIN reactivation take?</div>
                                    <div class="faq-answer">
                                ...
                                <div class="faq-item">
                                    <div class="faq-question">What documents are required for reactivation?</div>
                                    <div class="faq-answer">
                                ...
                                <div class="faq-item">
                                    <div class="faq-question">Can a deactivated DIN be used for new appointments?</div>
                                    <div class="faq-answer">
