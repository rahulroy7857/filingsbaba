...
@section('title', 'LLP Form 11 Filing - FilingsBaba')
            ...
            <div class="row">
                <div class="col-lg-8 col-md-12 col-sm-12">
                    <div class="service-details-content">
                        <div class="image-box">
                            <img src="{{ asset('main/images/services/llp-form11-filing.jpg') }}" alt="LLP Form 11 Filing">
                        </div>

                        <div class="content-box">
                            <h2>LLP Form 11 Filing</h2>
                            <p>File your LLP Form 11 (Annual Return) efficiently with our professional services. We ensure
                                timely compliance and help you maintain proper records for your LLP.</p>

                            <div class="features-box">
                                <h3>What We Offer</h3>
                                <ul>
                                    <li><i class="lnr lnr-checkmark-circle"></i> Partner Details Collection</li>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="process-step">
                                            ...
                                            <p>Professional handling of data collection with expert guidance.</p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="process-step">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="process-step">
                                            ...
                                            <h4>LLP Form 11 Filing</h4>
                                            <p>Professional handling of LLP Form 11 filing with expert guidance.</p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="process-step">
                            ...
                            <div class="benefits-box">
                                <h3>Benefits</h3>
                                <ul>
                                    <li><i class="lnr lnr-arrow-right"></i> Legal LLP Form 11 Filing</li>
                                    <li><i class="lnr lnr-arrow-right"></i> Professional Documentation</li>
                                    <li><i class="lnr lnr-arrow-right"></i> Timely Processing</li>
                                    <li><i class="lnr lnr-arrow-right"></i> Compliance Assurance</li>
                                    <li><i class="lnr lnr-arrow-right"></i> Post-filing Support</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="pricing-block">
                        <div class="inner-box">
                            ...
                            <div class="content">
                                <ul>
                                    <li>Basic LLP Form 11 Filing</li>
