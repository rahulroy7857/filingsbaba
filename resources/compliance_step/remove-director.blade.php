...
@section('title', 'Remove Director - FilingsBaba')
            ...
            <div class="row">
                <div class="col-lg-8 col-md-12 col-sm-12">
                    <div class="service-details-content">
                        <div class="image-box">
                            <img src="{{ asset('main/images/services/remove-director.jpg') }}" alt="Remove Director">
                        </div>

                        <div class="content-box">
                            <h2>Remove Director</h2>
                            <p>Remove directors from your company efficiently with our professional services. We handle all
                                the necessary procedures and filings to ensure smooth director removal process.</p>
                            ...
                            <div class="features-box">
                                ...
                                <ul>
                                    ...
                                    <li><i class="lnr lnr-checkmark-circle"></i> Post-removal Support</li>
                                </ul>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="process-step">
                                            ...
                                            <p>Professional handling of resignation letter with expert guidance.</p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="process-step">
                            ...
                            <div class="benefits-box">
                                <h3>Benefits</h3>
                                <ul>
                                    <li><i class="lnr lnr-arrow-right"></i> Legal Director Removal</li>
                            ...
                            <div class="faq-section">
                                ...
                                <div class="faq-item">
                                    <div class="faq-question">What is Director Removal?</div>
                                ...
                                <div class="faq-item">
                                    <div class="faq-question">How long does the director removal process take?</div>
                                    <div class="faq-answer">
                                ...
                                <div class="faq-item">
                                    <div class="faq-question">What forms are required for director removal?</div>
                                    <div class="faq-answer">
                                ...
                                <div class="faq-item">
                                    <div class="faq-question">Is shareholder approval required for director removal?</div>
                                    <div class="faq-answer">
                                ...
                                <div class="faq-item">
                                    <div class="faq-question">Can a director be removed without notice?</div>
                                    <div class="faq-answer">
